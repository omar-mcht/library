      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <span class="dropdown-item dropdown-header">{{ $count }} Notifications</span>        
            @foreach ($unreturn as $item)
            <div class="dropdown-divider"></div>
            <a href="{{url('transactions/'.$item->id)}}" class="dropdown-item" value="show">
            <i class="fas fa-users mr-2"></i> {{$item->member->name}} <br> <small>melewati batas waktu {{ intval(datediff2($item))-3 }} hari</small> 
